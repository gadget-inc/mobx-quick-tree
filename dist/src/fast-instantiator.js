...
class InstantiatorBuilder {
  ...
  `;
        ...
        return aliasFunc(this.model, { $identifier: symbols_1.$identifier, $env: symbols_1.$env, $parent: symbols_1.$parent, $memos: symbols_1.$memos, $memoizedKeys: symbols_1.$memoizedKeys, $readOnly: symbols_1.$readOnly, $type: symbols_1.$type, QuickMap: map_1.QuickMap, QuickArray: array_1.QuickArray });
    }
