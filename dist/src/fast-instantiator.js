...
exports.FastGetBuilder = exports.buildFastInstantiator = void 0;
...
class FastGetBuilder {
  ...
  `);
        return builder({ $readOnly: symbols_1.$readOnly, $memoizedKeys: symbols_1.$memoizedKeys, $memos: symbols_1.$memos, descriptor });
    }
}
