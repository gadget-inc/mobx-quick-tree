...
exports.safeReference = exports.reference = exports.SafeReferenceType = exports.ReferenceType = void 0;
...
const referenceSchemaHash = async (type, targetType) => {
    if (!referenceIDs.has(targetType)) {
        referenceIDs.set(targetType, referenceIDCounter++);
    }
    return `${type}:${referenceIDs.get(targetType)}:${await targetType.schemaHash()}`;
};
