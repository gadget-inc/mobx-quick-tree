...
exports.isClassModel = exports.getPropertyDescriptor = exports.ensureRegistered = exports.extend = exports.volatile = exports.snapshottedView = exports.view = exports.volatileAction = exports.action = exports.register = exports.ClassModel = void 0;
...
function register(object, tags, name) {
    ...
    const snapshottedViews = metadatas.filter((metadata) => metadata.type == "snapshotted-view");
    if (snapshottedViews.length > 0) {
            ...
            postProcessor(snapshot, node) {
                ...
                if (stn.state == 2 /** NodeLifeCycle.FINALIZED */) {
                    for (const snapshottedView of snapshottedViews) {
                        (0, snapshot_1.storeViewOnSnapshot)(node, snapshottedView, snapshot);
                    }
                }
                return snapshot;
            },
    ...
    klass.snapshottedViews = snapshottedViews;
    ...
    //   - .is
    //   - .instantiate
    return new fast_instantiator_1.InstantiatorBuilder(klass, fastGetters, snapshottedViews).build();
}
...
function snapshottedView(options = {}) {
    return (target, property, _descriptor) => {
        const metadata = { type: "snapshotted-view", property, cache: options };
        Reflect.defineMetadata(`${viewKeyPrefix}:${property}`, metadata, target);
    };
}
