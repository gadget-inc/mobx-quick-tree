...
exports.isClassModel = exports.ensureRegistered = exports.extend = exports.volatile = exports.view = exports.volatileAction = exports.action = exports.register = exports.ClassModel = void 0;
...
class BaseClassModel {
    ...
    constructor(snapshot, context, parent, 
    /** @hidden */ hackyPreventInitialization = false) {
        ...
        this[symbols_1.$env] = context.env;
        this[symbols_1.$parent] = parent;
        this.constructor[fast_instantiator_1.$fastInstantiator](this, snapshot, context);
    }
    get [(_a = symbols_1.$requiresRegistration, _b = symbols_1.$quickType, _c = $memos, _d = $memoizedKeys, symbols_1.$readOnly)]() {
        return true;
    }
    get [symbols_1.$type]() {
...
const ClassModel = (propertiesDeclaration) => {
    ...
    return _e = class extends BaseClassModel {
        },
        _e.properties = props,
        _e;
};
...
function register(object, tags, name) {
                ...
                if (descriptor.get) {
                    Object.defineProperty(klass.prototype, property, {
                        ...
                        get() {
                            ...
                            if (this[$memoizedKeys]?.[property])
                                return this[$memos][property];
                            this[$memoizedKeys] ?? (this[$memoizedKeys] = {});
    ...
    klass.createReadOnly = (snapshot, env) => {
        ...
        const instance = new klass(snapshot, context, null);
    ...
    klass[fast_instantiator_1.$fastInstantiator] = (instance, snapshot, context) => {
        const intantiator = (0, fast_instantiator_1.buildFastInstantiator)(klass);
        klass[fast_instantiator_1.$fastInstantiator] = intantiator;
