...
function register(object, tags, name) {
    ...
    klass.schemaHash = (0, lodash_memoize_1.default)(async () => {
        ...
        return `model:${klass.name}:${await (0, utils_1.sha1)(propHashes.join("|"))}`;
    });
    ...
    klass[fast_instantiator_1.$fastInstantiator] = (0, fast_instantiator_1.buildFastInstantiator)(klass);
