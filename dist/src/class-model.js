...
exports.isClassModel = exports.getPropertyDescriptor = exports.ensureRegistered = exports.extend = exports.volatile = exports.view = exports.volatileAction = exports.action = exports.register = exports.ClassModel = void 0;
...
function register(object, tags, name) {
    ...
    const fastGetters = new fast_instantiator_1.FastGetBuilder(metadatas, klass);
    ...
    // .is
    // .instantiate
    klass = (0, fast_instantiator_1.buildFastInstantiator)(klass);
