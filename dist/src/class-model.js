...
const ClassModel = (propertiesDeclaration) => {
    ...
    return _f = class Base {
            ...
            /** @hidden */ hackyPreventInitialization = false) {
                ...
                (0, model_1.instantiateInstanceFromProperties)(this, attrs, this.constructor.properties, klass.mstType.identifierAttribute, context);
            ...
            get [(_a = symbols_1.$requiresRegistration, _b = symbols_1.$quickType, _c = symbols_1.$parent, _d = $memos, _e = $memoizedKeys, symbols_1.$readOnly)]() {
                return true;
            }
            get [symbols_1.$type]() {
