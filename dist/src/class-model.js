...
exports.isClassModel = exports.ensureRegistered = exports.view = exports.volatileAction = exports.action = exports.ClassModel = void 0;
...
function register(object, tags, name) {
    ...
    let mstType = mobx_state_tree_1.types.model(klass.name, (0, model_1.mstPropsFromQuickProps)(klass.properties));
