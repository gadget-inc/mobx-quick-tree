...
export interface IClassModelType<Props extends ModelProperties, InputType = InputsForModel<InputTypesForModelProps<Props>>, OutputType = OutputTypesForModelProps<Props>> {
     ...
     **/
    new (attrs?: this["InputType"], env?: any, context?: InstantiateContext): InstanceTypesForModelProps<TypesForModelPropsDeclaration<Props>> & {
 ...
 */
export type Instance<T> = T extends IReferenceType<any> ? T["InstanceTypeWithoutSTN"] : T extends IMaybeType<any> ? T["InstanceTypeWithoutSTN"] : T extends IType<any, any, any> ? T["InstanceType"] : T extends IAnyClassModelType ? InstanceType<T> : T;
