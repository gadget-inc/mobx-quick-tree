 ...
 */
export type Instance<T> = T extends IReferenceType<any> ? T["InstanceTypeWithoutSTN"] : T extends IType<any, any, any> ? T["InstanceType"] : T extends IAnyClassModelType ? InstanceType<T> : T;
