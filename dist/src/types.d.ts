...
export interface IClassModelType<Props extends ModelProperties, InputType = InputsForModel<InputTypesForModelProps<Props>>, OutputType = OutputTypesForModelProps<Props>> {
     ...
     */
    extend<T extends Constructor, SubClassProps extends ModelPropertiesDeclaration>(this: T, subclassProps: SubClassProps): T & {
        new (...args: any[]): InstanceType<T> & InstanceTypesForModelProps<TypesForModelPropsDeclaration<SubClassProps>>;
    };
    /** @hidden */
