...
export type InstanceWithoutSTNTypeForType<T extends IAnyType> = T extends IClassModelType<any, any> ? InstanceType<T> : T extends IType<any, any, any> ? T["InstanceTypeWithoutSTN"] : T;
