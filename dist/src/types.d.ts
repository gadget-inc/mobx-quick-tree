...
export type IUnionType<Types extends [IAnyType, ...IAnyType[]]> = Types[number] extends IAnyClassModelType ? Types[number] : IType<Types[number]["InputType"], Types[number]["OutputType"], InstanceWithoutSTNTypeForType<Types[number]>>;
