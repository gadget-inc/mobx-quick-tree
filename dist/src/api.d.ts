...
import type { CreateTypes, IAnyComplexType, IAnyModelType, IAnyStateTreeNode, IAnyType, IArrayType, IClassModelType, IMapType, IReferenceType, IStateTreeNode, IType, Instance, SnapshotIn, TreeContext } from "./types";
export { addDisposer, addMiddleware, applyPatch, clone, createActionTrackingMiddleware2, destroy, detach, escapeJsonPath, getIdentifier, getPath, getPathParts, getRunningActionContext, hasParent, isActionContextThisOrChildOf, isAlive, isValidReference, joinJsonPath, onAction, onPatch, recordPatches, resolvePath, setLivelinessChecking, splitJsonPath, tryReference, typecheck, unescapeJsonPath, walk, } from "mobx-state-tree";
...
/** @hidden */
export declare function getContext(value: IAnyStateTreeNode): TreeContext | null;
export declare function getEnv<Env = any>(value: IAnyStateTreeNode): Env;
export declare function hasEnv(value: IAnyStateTreeNode): boolean;
