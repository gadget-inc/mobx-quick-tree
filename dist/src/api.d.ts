...
import type { CreateTypes, IAnyComplexType, IAnyModelType, IAnyStateTreeNode, IAnyType, IArrayType, IMapType, Instance, IReferenceType, IStateTreeNode, IType, SnapshotIn } from "./types";
 ...
 */
export declare function flow<R, T, Args extends any[]>(generator: (this: T, ...args: Args) => Generator<PromiseLike<any>, R, any>): (...args: Args) => Promise<FlowReturn<R>>;
/**
 ...
 */
export declare const create: <T extends IAnyType>(type: T, snapshot?: SnapshotIn<T> | undefined, readOnly?: boolean, env?: Record<string, any>) => Instance<T>;
