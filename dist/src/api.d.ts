...
import type { CreateTypes, IAnyComplexType, IAnyModelType, IAnyStateTreeNode, IAnyType, IArrayType, IClassModelType, IMapType, IReferenceType, IStateTreeNode, IType, Instance, InstantiateContext, SnapshotIn } from "./types";
...
/** @hidden */
export declare function getContext(value: IAnyStateTreeNode): InstantiateContext | null;
