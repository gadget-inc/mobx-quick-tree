 ...
 */
export declare const action: (target: any, property: string, descriptor?: PropertyDescriptor) => void;
/**
 ...
 */
export declare function volatile(initializer: (instance: any) => any): (target: any, property: string) => void;
/**
