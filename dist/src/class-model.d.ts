...
import type { Constructor, ExtendedClassModel, IAnyClassModelType, IAnyType, IClassModelType, Instance, ModelPropertiesDeclaration, SnapshotIn, TypesForModelPropsDeclaration } from "./types";
/** @internal */
type ActionMetadata = {
    type: "action";
    property: string;
