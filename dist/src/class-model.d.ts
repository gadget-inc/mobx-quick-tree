...
export interface CachedViewOptions<V, T extends IAnyClassModelType> {
    createReadOnly?: (value: V | undefined, snapshot: T["InputType"]) => V | undefined;
 ...
 * }
 */
export declare const ClassModel: <PropsDeclaration extends ModelPropertiesDeclaration>(propertiesDeclaration: PropsDeclaration) => IClassModelType<TypesForModelPropsDeclaration<PropsDeclaration>, import("./types").InputsForModel<import("./types").InputTypesForModelProps<TypesForModelPropsDeclaration<PropsDeclaration>>>, import("./types").OutputTypesForModelProps<TypesForModelPropsDeclaration<PropsDeclaration>>>;
/**
 ...
 * }
 */
export declare function cachedView<V, T extends IAnyClassModelType = IAnyClassModelType>(options?: CachedViewOptions<V, T>): (target: any, property: string, _descriptor: PropertyDescriptor) => void;
/**
