...
exports.onSnapshot = exports.applySnapshot = exports.resolveIdentifier = exports.isRoot = exports.getRoot = exports.hasEnv = exports.getEnv = exports.getContext = exports.getType = exports.getParentOfType = exports.getParent = exports.isReadOnlyNode = exports.isStateTreeNode = exports.isType = exports.getSnapshot = exports.volatileAction = exports.volatile = exports.snapshottedView = exports.view = exports.register = exports.extend = exports.action = exports.ClassModel = exports.walk = exports.unescapeJsonPath = exports.typecheck = exports.tryReference = exports.splitJsonPath = exports.setLivelinessChecking = exports.resolvePath = exports.recordPatches = exports.onPatch = exports.onAction = exports.joinJsonPath = exports.isValidReference = exports.isAlive = exports.isActionContextThisOrChildOf = exports.hasParent = exports.getRunningActionContext = exports.getPathParts = exports.getPath = exports.getIdentifier = exports.escapeJsonPath = exports.detach = exports.destroy = exports.createActionTrackingMiddleware2 = exports.clone = exports.applyPatch = exports.addMiddleware = exports.addDisposer = void 0;
exports.flow = exports.cast = exports.isIdentifierType = exports.isReferenceType = exports.isModelType = exports.isMapType = exports.isArrayType = void 0;
...
Object.defineProperty(exports, "getRunningActionContext", { enumerable: true, get: function () { return mobx_state_tree_2.getRunningActionContext; } });
...
Object.defineProperty(exports, "snapshottedView", { enumerable: true, get: function () { return class_model_1.snapshottedView; } });
...
function getContext(value) {
    ...
    while (currentNode) {
        const context = currentNode[symbols_1.$context];
...
function hasEnv(value) {
    if ((0, mobx_state_tree_1.isStateTreeNode)(value)) {
        return (0, mobx_state_tree_1.hasEnv)(value);
    }
...
function resolveIdentifier(type, target, identifier) {
    ...
    return context.referenceCache.get(identifier);
}
